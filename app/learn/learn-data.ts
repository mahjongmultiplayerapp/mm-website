...
export const learnSections: LearnSection[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { number: '6.5', slug: 'beginner-fan', title: 'Beginner Fan', objective: 'Recognize accessible beginner scoring patterns.' },
      { number: '6.6', slug: 'intermediate-fan', title: 'Intermediate Fan', objective: 'Preview more valuable common patterns.' },
      { number: '6.7', slug: 'limit-hands', title: 'Limit Hands', objective: 'Understand the idea of top-value hands.' },
      { number: '6.8', slug: 'points-conversion-table', title: 'Points Conversion Table', objective: 'Use a table to convert fan to payments.' },
      { number: '6.9', slug: 'presenting-a-winning-hand', title: 'Presenting a Winning Hand', objective: 'Show a win clearly for scoring.' },
    ],
  },
  {
    number: 7,
