...
import { getFirstLessonPath, getSectionPath, learnSections, totalLessonCount } from '../learn-data';
        ...
        <div className="wrap">
          ...
          <div className="learn-section-grid">
            {learnSections.map((section) => (
              <Link className="learn-section-card" href={getSectionPath(section.slug)} key={section.slug}>
      ...
      <section className="learn-outcome tight felt">
        <div className="wrap">
          <div className="final learn-outcome-card">
            ...
            <Link className="btn-primary gold" href="/learn/hong-kong/final-readiness-test">
              Take Final Quiz
            </Link>
          </div>
        </div>
